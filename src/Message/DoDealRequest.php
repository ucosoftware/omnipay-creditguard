...
class DoDealRequest extends AbstractRequest
{
     ...
     * @return static
     */
    public function setCvv($value) { return $this->set('cvv', $value); }
     ...
     * @return static
     */
    public function setId($value) { return $this->set('id', $value); }
     ...
     * @return static
     */
    public function setClientIp($value) { return $this->set('clientIP', $value); }
